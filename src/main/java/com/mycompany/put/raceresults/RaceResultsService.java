...
public class RaceResultsService {
	...
	private Map<Categories, List<Client>> clients = new EnumMap<Categories, List<Client>>(Categories.class);
	LogService logService;
	
	public RaceResultsService(LogService logService){
		this.logService = logService;
		Arrays.stream(Categories.values()).forEach(cat->clients.put(cat, new ArrayList<Client>()));
	}
